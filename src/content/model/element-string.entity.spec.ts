...
describe("ElementString entity", () => {
  ...
  describe('ElementString fields', () => {
    ...
    test('Shouldn`t create without parent', async () => {
      ...
      await expect(Object.assign(new ElementStringEntity(), { string: 'VALUE', property }).save()).rejects.toThrow();
    });
    ...
    test('Shouldn`t create without property', async () => {
      ...
      await expect(Object.assign(new ElementStringEntity(), { string: 'VALUE', parent }).save()).rejects.toThrow();
    });
  });
